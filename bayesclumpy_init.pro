...
; Generate the full wavelength axis
	...
	state.baseWidget = widget_base(TITLE=version, XSIZE=xsiz, YSIZE=ysiz)
...
; Plotting windows
	...
	state.plotSEDWidget = widget_draw(horizplotBase, XSIZE=xsiz_plot, YSIZE=ysiz_plot, /FRAME)
...
; Plotting windows
	...
	state.plotleftWidget = widget_draw(horizplotBase, XSIZE=xsiz_plot, YSIZE=ysiz_plot, /FRAME)
	state.plotrightWidget = widget_draw(horizplotBase, XSIZE=xsiz_plot, YSIZE=ysiz_plot, /FRAME)
