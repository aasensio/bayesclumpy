...
; $Id: //depot/Release/ENVI51_IDL83/idl/idldir/lib/errplot.pro#1 $
;
; Copyright (c) 1983-2013, Exelis Visual Information Solutions, Inc. All
...
;-
Pro MyErrplot, X, Low, High, Width = width, $
